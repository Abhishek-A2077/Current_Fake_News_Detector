...
try:
    loaded_model = pickle.load(open("/home/abhishek-a/Code/Fake_News_Detection/model_6class.pkl", 'rb'))
    vector = pickle.load(open("/home/abhishek-a/Code/Fake_News_Detection/vector_6class.pkl", 'rb'))
    label_encoder = pickle.load(open("/home/abhishek-a/Code/Fake_News_Detection/label_encoder_6class.pkl", 'rb'))
    print("Loaded 6-class model successfully!")
except:
    # Fallback to binary model if 6-class model not foSund
